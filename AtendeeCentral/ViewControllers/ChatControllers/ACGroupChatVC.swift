...
//  AtendeeCentral
//
//  Created by Probir Chakraborty on 08/09/16.
...
class ACGroupChatVC: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,AVAudioPlayerDelegate,AVAudioRecorderDelegate,UICollectionViewDataSource , UICollectionViewDelegate,MZDayPickerDelegate,MZDayPickerDataSource  {
    ...
    @IBAction func participantsButtonAction(sender: UIButton) {
        let participantsVC = self.storyboard?.instantiateViewControllerWithIdentifier("ACGroupParticipantsListVCID") as! ACGroupParticipantsListVC
